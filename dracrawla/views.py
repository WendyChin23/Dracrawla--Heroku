    ...
    def post(self, request):
        ...
        if request.method == 'POST':
            if 'BtnUpdate' in request.POST:
                ...
                updateid = request.POST.get("did-uid")                                                                                                                                                                                                                                                                                                                                            
                ...
                update_drainage = Drainage.objects.filter(did=updateid).update(size = dsize, 
                ...
                Did = request.POST.get("drain-did")
                announce = Drainage.objects.filter(did=Did).delete()
                print("deleted")
...
class CreateAnnouncements(View):
    ...
    def post(self, request):        
        ...
        if form.is_valid():
            ...
            form = Annoucement(id = Id, title=Title, content=Content, date=Date)
            print('clicked')
            form.save()
